package com.example.latihan010;
...
public class ContactDetail extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tname = (TextView) findViewById(R.id.tv1);
		taddress = (TextView) findViewById(R.id.tv2);
		temail = (TextView) findViewById(R.id.tv4);
		tphone = (TextView) findViewById(R.id.tv6);
		tdob = (TextView) findViewById(R.id.tv8
				);
